/**
 * Check-in service — handles check-ins and surfer counts.
 *
 * All operations persist to Firestore. The function signatures are unchanged
...
/** No-op — kept so api.ts can call it without changes. */
export const initializeCheckInService = () => {};
